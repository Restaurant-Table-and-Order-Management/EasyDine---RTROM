...
public class SecurityConfig {
    ...
    public SecurityConfig(
            ...
            @org.springframework.beans.factory.annotation.Value("${cors.allowed-origins:http://localhost:5173,http://127.0.0.1:5173,https://*.vercel.app}") String allowedOrigins
    ) {
